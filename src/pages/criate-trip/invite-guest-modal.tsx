...
export function InviteGuestModal({ addNewEmailToInvite, closeGuestsModal, emailsToInvite, removeEmail }: InviteGuestModalProps) {
    return (
            ...
            <div className='w-[640px] round-xl px-5 py-6 shadow-shape bg-zinc-900 space-y-5'>
                <div className='space-y-2'>
                    <div className=' flex items-center justify-between'>
                        ...
                        <Button onClick={closeGuestsModal} variant="secondary" size='full'>
                            <X className='size-5' />
                            Cadastrar novo link
                        </Button>
                    </div>
